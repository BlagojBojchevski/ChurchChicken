...
open class CustomEditTextCoode : AppCompatEditText, View.OnTouchListener,
    ...
    override fun onTextChanged(view: EditText, text: String) {
        ...
        if (text.length > 1) {
            ...
            view.setBackgroundResource(R.drawable.edit_text_style_red_no_corners)
        }

        view.filters = arrayOf(Engine().spaceFilter, InputFilter.LengthFilter(50),InputFilter.AllCaps())
