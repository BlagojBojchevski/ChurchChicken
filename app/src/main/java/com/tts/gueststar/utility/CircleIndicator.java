...
public class CircleIndicator extends LinearLayout {
    ...
    private int mIndicatorBackgroundResId = R.drawable.selected_dot;
    private int mIndicatorUnselectedBackgroundResId = R.drawable.unselected_dot;
    ...
    private void handleTypedArray(Context context, AttributeSet attrs) {
        ...
        mAnimatorResId = typedArray.getResourceId(R.styleable.BaseCircleIndicator_ci_animator,
        ...
        int orientation = typedArray.getInt(R.styleable.BaseCircleIndicator_ci_orientation, -1);
        setOrientation(orientation == VERTICAL ? VERTICAL : HORIZONTAL);

        int gravity = typedArray.getInt(R.styleable.BaseCircleIndicator_ci_gravity, -1);
    ...
    public void configureIndicator(int indicatorWidth, int indicatorHeight, int indicatorMargin) {
        configureIndicator(indicatorWidth, indicatorHeight, indicatorMargin,
                R.animator.scale_with_alpha, 0, R.drawable.selected_dot, R.drawable.selected_dot);
    }
    ...
    private void checkIndicatorConfig(Context context) {
        ...
        mIndicatorBackgroundResId = (mIndicatorBackgroundResId == 0) ? R.drawable.selected_dot
                : mIndicatorBackgroundResId;
        mIndicatorUnselectedBackgroundResId =
