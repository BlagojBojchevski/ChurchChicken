...
open class CustomEditTextLastName : AppCompatEditText, View.OnTouchListener,
    ...
    override fun onTextChanged(view: EditText, text: String) {
        if (isFocused) {
            ...
            view.filters = arrayOf(spaceFilter, InputFilter.LengthFilter(50))
        }
    }
    ...
    private fun init() {
        ...
        super.setFilters(arrayOf(spaceFilter, InputFilter.LengthFilter(50)))
    }
