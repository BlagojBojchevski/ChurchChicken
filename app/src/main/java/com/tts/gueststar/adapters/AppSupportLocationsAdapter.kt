...
class AppSupportLocationsAdapter(
    val context: Context,
    private val locations: List<LocationsResponse.Location>,
    val listener: AppSupportListener
) : RecyclerView.Adapter<AppSupportLocationsAdapter.LocationViewHolder>() {
    ...
    override fun onBindViewHolder(holder: LocationViewHolder, position: Int) {
        ...
        holder.layout.setOnClickListener {
            listener.sendEmail(locations[position].app_display_text)
        }
    }
    ...
    class LocationViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun init(location: LocationsResponse.Location, context: Context) {
            ...
            locationDistance.text = context.getString(
